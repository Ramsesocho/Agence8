...
<html lang="fr">
<head>
<script src="/docs/5.3/assets/js/color-modes.js"></script> <!--Pris depuis bootstrap pour le footer -->
    <meta charset="UTF-8">
    ...
    <!--Pris depuis bootstrap pour le footer -->
 <!-- Favicons -->
...
<style>
    ...
    <title>@yield('title') | Agence8</title>
</head>
<body>
